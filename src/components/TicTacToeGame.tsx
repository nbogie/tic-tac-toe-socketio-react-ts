...
import { getTeamCharacterFor, getWinStatus, makeInitialGameState, textForContent } from '../game';
...
export function TicTacToeGame({ socket, connectionStatus, roomId, playerId }: TTTGameProps) {
